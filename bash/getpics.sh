...
#downloaded the tar file to the Pictures directory if it is not there
...
#installed/extracted the files from the tar file to the Pictures directory and if successfull, the local copy of the tar file is deleted.
